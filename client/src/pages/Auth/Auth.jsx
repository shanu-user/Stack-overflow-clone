        ...
        </label><br />
        {
           isSignup && (
            <label htmlFor='check'>
              ...
              <p>Opt-in to receive occasional, product updates, user research invitations, company announcements, and digests.</p>
            </label>
           )
        }
        <button type="submit" className='auth-btn'>{isSignup ? 'Sign Up': 'Login'}</button>
        {
            isSignup && (
              <p style={{color: "666767", fontSize: "13px"}}>
                ...
                our <span style={{color: "#007ac6"}}>terms of<br /> service</span>,
